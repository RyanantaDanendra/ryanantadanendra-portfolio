            ...
            <Container maxWidth={false} sx={{
                ...
                <Grid container spacing={0} sx={{ display: 'flex', justifyContent: 'center', paddingX: '20px' }}>
                    <Grid item xs={4} sx={{
                        ...
                        <Typography data-aos="fade-right" data-aos-delay='1500' variant='h5' sx={{ marginTop: '10px' }}>Full - Stack Web Developer <br />
                        Building Scalable, Robust Web Applications</Typography>
                        <Button data-aos='zoom-in-right' data-aos-delay='1800' sx={{ marginTop: '20px', paddingX: '40px', paddingY: '20px', backgroundColor: '#003366', borderRadius: '30px', color: 'white', '&:hover': { color: 'black', border: 'black 2px solid', backgroundColor: 'white'} }}>Email Me</Button>
                    </Grid>
                    <Grid item xs={4}>
                        <img src={Me} alt="Me" className='hero-image' data-aos='zoom-in' data-aos-delay='2300' data-aos-easing='ease-out' data-aos-duration='300500' />
                    </Grid>
                    <Grid item xs={3} sx={{ marginTop: '160px', display: 'flex', justifyContent: 'center' }}>
                        <a href=""> 
                            <Box data-aos='zoom-out' data-aos-delay='2800' sx={{ 
                                width: '150px',
                                height: '150px',
